...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeCrave = new QSpinBox(tabMain);
        anonymizeCrave->setObjectName(QStringLiteral("anonymizeCrave"));
        anonymizeCrave->setMinimum(2);
        anonymizeCrave->setMaximum(10000);
        anonymizeCrave->setSingleStep(10);
        anonymizeCrave->setValue(1000);

        gridLayout->addWidget(anonymizeCrave, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start ZACA after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start ZACA on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of ZACA to keep anonymized", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Zaca client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Zaca network through a SOCKS5 proxy (e.g. when connecting through Tor).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Zaca.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
