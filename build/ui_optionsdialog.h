...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeZaca = new QSpinBox(tabMain);
        anonymizeZaca->setObjectName(QStringLiteral("anonymizeZaca"));
        anonymizeZaca->setMinimum(2);
        anonymizeZaca->setMaximum(10000);
        anonymizeZaca->setSingleStep(10);
        anonymizeZaca->setValue(1000);

        gridLayout->addWidget(anonymizeZaca, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        transactionFeeInfoLabel->setText(QApplication::translate("OptionsDialog", "Optional transaction fee per kB that helps make sure your transactions are processed quickly. Most transactions are 1 kB. Fee 0.0001 recommended.", 0));
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Zaca after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Zaca on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Zaca to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Zaca client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Zaca network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
