...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Zaca", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Zaca</b> version", 0));
...
"Copyright \302\251 2018 The Zaca developers", 0));
