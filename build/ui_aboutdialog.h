...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Zaca", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Zaca</b> version", Q_NULLPTR));
...
"Copyright \302\251 2014 The Zaca developers", Q_NULLPTR));
