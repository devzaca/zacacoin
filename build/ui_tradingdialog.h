...
public:
    ...
    QLabel *label_17;
    QPushButton *BuyCRAVE;
    QPushButton *SellCRAVEBTN;
    ...
    QLabel *label_11;
    QLabel *CRAVEBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *CRAVEAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *CRAVEPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        CRAVEAvailableLabel = new QLabel(BuyTab);
        CRAVEAvailableLabel->setObjectName(QStringLiteral("CRAVEAvailableLabel"));
        QPalette palette1;
        ...
        CRAVEAvailableLabel->setPalette(palette1);
        CRAVEAvailableLabel->setFont(font3);
        CRAVEAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(CRAVEAvailableLabel);

        labelCRAVE = new QLabel(BuyTab);
        labelCRAVE->setObjectName(QStringLiteral("labelCRAVE"));
        labelCRAVE->setFont(font3);

        horizontalLayout->addWidget(labelCRAVE);
        ...
        UnitsInputCRAVE = new QLineEdit(BuyTab);
        UnitsInputCRAVE->setObjectName(QStringLiteral("UnitsInputCRAVE"));
        UnitsInputCRAVE->setMinimumSize(QSize(0, 0));
        UnitsInputCRAVE->setFont(font5);

        gridLayout_6->addWidget(UnitsInputCRAVE, 4, 9, 1, 1);
        ...
        BuyCRAVE = new QPushButton(BuyTab);
        BuyCRAVE->setObjectName(QStringLiteral("BuyCRAVE"));

        gridLayout_6->addWidget(BuyCRAVE, 7, 3, 1, 1);

        SellCRAVEBTN = new QPushButton(BuyTab);
        SellCRAVEBTN->setObjectName(QStringLiteral("SellCRAVEBTN"));

        gridLayout_6->addWidget(SellCRAVEBTN, 7, 9, 1, 1);
        ...
        CRAVEDemand = new QLabel(BuyTab);
        CRAVEDemand->setObjectName(QStringLiteral("CRAVEDemand"));
        QFont font6;
        font6.setPointSize(8);
        CRAVEDemand->setFont(font6);
        CRAVEDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(CRAVEDemand, 0, 1, 1, 5);

        CRAVESupply = new QLabel(BuyTab);
        CRAVESupply->setObjectName(QStringLiteral("CRAVESupply"));
        CRAVESupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(CRAVESupply, 0, 9, 1, 3);
        ...
        BittrexCRAVELabel = new QLabel(tab);
        BittrexCRAVELabel->setObjectName(QStringLiteral("BittrexCRAVELabel"));
        QPalette palette7;
        ...
        BittrexCRAVELabel->setPalette(palette7);
        BittrexCRAVELabel->setFont(font7);
        BittrexCRAVELabel->setAutoFillBackground(false);
        BittrexCRAVELabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexCRAVELabel);
        ...
        CRAVEBalanceLabel = new QLabel(BalanceTab);
        CRAVEBalanceLabel->setObjectName(QStringLiteral("CRAVEBalanceLabel"));
        CRAVEBalanceLabel->setFont(font4);
        CRAVEBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CRAVEBalanceLabel, 0, 3, 1, 1);
        ...
        CRAVEAvailableLabel_2 = new QLabel(BalanceTab);
        CRAVEAvailableLabel_2->setObjectName(QStringLiteral("CRAVEAvailableLabel_2"));
        CRAVEAvailableLabel_2->setFont(font4);
        CRAVEAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CRAVEAvailableLabel_2, 1, 3, 1, 1);
        ...
        CRAVEPendingLabel = new QLabel(BalanceTab);
        CRAVEPendingLabel->setObjectName(QStringLiteral("CRAVEPendingLabel"));
        CRAVEPendingLabel->setFont(font4);
        CRAVEPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(CRAVEPendingLabel, 2, 3, 1, 1);
        ...
        CRAVEBalanceLabel->raise();
        CRAVEAvailableLabel_2->raise();
        CRAVEPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "ZACA Available:", Q_NULLPTR));
        CRAVEAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", Q_NULLPTR));
        labelCRAVE->setText(QApplication::translate("tradingDialog", " ZACA", Q_NULLPTR));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", Q_NULLPTR));
        label_4->setText(QApplication::translate("tradingDialog", "ZACA", Q_NULLPTR));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", Q_NULLPTR));
        label_22->setText(QApplication::translate("tradingDialog", "ZACA", Q_NULLPTR));
        ...
        BuyCRAVE->setText(QApplication::translate("tradingDialog", "Buy ZACA", Q_NULLPTR));
        SellCRAVEBTN->setText(QApplication::translate("tradingDialog", "Sell ZACA", Q_NULLPTR));
        ...
        CRAVEDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 ZACA", Q_NULLPTR));
        CRAVESupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 ZACA", Q_NULLPTR));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in ZACA:", Q_NULLPTR));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", Q_NULLPTR));
        label_35->setText(QApplication::translate("tradingDialog", "ZACA", Q_NULLPTR));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "ZACA Balance:", Q_NULLPTR));
        BittrexCRAVELabel->setText(QApplication::translate("tradingDialog", " 0.00000000", Q_NULLPTR));
        label_30->setText(QApplication::translate("tradingDialog", "ZACA", Q_NULLPTR));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "ZACA Balance:", Q_NULLPTR));
        CRAVEBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "ZACA Available:", Q_NULLPTR));
        CRAVEAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "ZACA Pending:", Q_NULLPTR));
        CRAVEPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate ZACA Coin Deposit Address", Q_NULLPTR));
...
#endif // QT_NO_SHORTCUT
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw ZACA:", Q_NULLPTR));
