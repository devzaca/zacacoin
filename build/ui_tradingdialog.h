...
public:
    ...
    QLabel *label_11;
    QLabel *ZACABalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *ZACAAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *ZACAPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        ZACAAvailableLabel = new QLabel(BuyTab);
        ZACAAvailableLabel->setObjectName(QStringLiteral("ZACAAvailableLabel"));
        QPalette palette1;
        ...
        ZACAAvailableLabel->setPalette(palette1);
        ZACAAvailableLabel->setFont(font3);
        ZACAAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(ZACAAvailableLabel);

        labelZACA = new QLabel(BuyTab);
        labelZACA->setObjectName(QStringLiteral("labelZACA"));
        labelZACA->setFont(font3);

        horizontalLayout->addWidget(labelZACA);
        ...
        UnitsInputZACA = new QLineEdit(BuyTab);
        UnitsInputZACA->setObjectName(QStringLiteral("UnitsInputZACA"));
        UnitsInputZACA->setMinimumSize(QSize(0, 0));
        UnitsInputZACA->setFont(font5);

        gridLayout_6->addWidget(UnitsInputZACA, 4, 9, 1, 1);
        ...
        BuyZACA = new QPushButton(BuyTab);
        BuyZACA->setObjectName(QStringLiteral("BuyZACA"));

        gridLayout_6->addWidget(BuyZACA, 7, 3, 1, 1);

        SellZACABTN = new QPushButton(BuyTab);
        SellZACABTN->setObjectName(QStringLiteral("SellZACABTN"));

        gridLayout_6->addWidget(SellZACABTN, 7, 9, 1, 1);
        ...
        ZACADemand = new QLabel(BuyTab);
        ZACADemand->setObjectName(QStringLiteral("ZACADemand"));
        QFont font6;
        font6.setPointSize(8);
        ZACADemand->setFont(font6);
        ZACADemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(ZACADemand, 0, 1, 1, 5);

        ZACASupply = new QLabel(BuyTab);
        ZACASupply->setObjectName(QStringLiteral("ZACASupply"));
        ZACASupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(ZACASupply, 0, 9, 1, 3);
        ...
        BittrexZACALabel = new QLabel(tab);
        BittrexZACALabel->setObjectName(QStringLiteral("BittrexZACALabel"));
        QPalette palette7;
        ...
        BittrexZACALabel->setPalette(palette7);
        BittrexZACALabel->setFont(font7);
        BittrexZACALabel->setAutoFillBackground(false);
        BittrexZACALabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexZACALabel);
        ...
        ZACABalanceLabel = new QLabel(BalanceTab);
        ZACABalanceLabel->setObjectName(QStringLiteral("ZACABalanceLabel"));
        ZACABalanceLabel->setFont(font4);
        ZACABalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(ZACABalanceLabel, 0, 3, 1, 1);
        ...
        ZACAAvailableLabel_2 = new QLabel(BalanceTab);
        ZACAAvailableLabel_2->setObjectName(QStringLiteral("ZACAAvailableLabel_2"));
        ZACAAvailableLabel_2->setFont(font4);
        ZACAAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(ZACAAvailableLabel_2, 1, 3, 1, 1);
        ...
        ZACAPendingLabel = new QLabel(BalanceTab);
        ZACAPendingLabel->setObjectName(QStringLiteral("ZACAPendingLabel"));
        ZACAPendingLabel->setFont(font4);
        ZACAPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(ZACAPendingLabel, 2, 3, 1, 1);
        ...
        ZACABalanceLabel->raise();
        ZACAAvailableLabel_2->raise();
        ZACAPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "ZACA Available:", 0));
        ZACAAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelZACA->setText(QApplication::translate("tradingDialog", " ZACA", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "ZACA", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "ZACA", 0));
        ...
        BuyZACA->setText(QApplication::translate("tradingDialog", "Buy ZACA", 0));
        SellZACABTN->setText(QApplication::translate("tradingDialog", "Sell ZACA", 0));
        ...
        ZACADemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 ZACA", 0));
        ZACASupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 ZACA", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in ZACA:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "ZACA", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "ZACA Balance:", 0));
        BittrexZACALabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "ZACA", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "ZACA Balance:", 0));
        ZACABalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "ZACA Available:", 0));
        ZACAAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "ZACA Pending:", 0));
        ZACAPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate ZACA Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw ZACA:", 0));
