...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ZACA"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ZACA"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ZACA"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ZACA"));
