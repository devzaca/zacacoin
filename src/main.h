...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 ZACA per COIN i.e. 8%
...
static const int64_t MAX_MONEY = 21000000 * COIN; // 21Mi PoW coins
...
inline int64_t GetMNCollateral(int nHeight) { return 7500; }
