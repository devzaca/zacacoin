...
private slots:
    ...
    QString BuyZACA(QString OrderType, double Quantity, double Rate);
    QString SellZACA(QString OrderType, double Quantity, double Rate);
