...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Zaca
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Zaca
    // Mac: ~/Library/Application Support/Zaca
    // Unix: ~/.zaca
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Zaca";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "zaca.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "zacad.pid"));
